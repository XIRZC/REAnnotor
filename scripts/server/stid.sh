...
PREFIX1="bash "
PREFIX2="-opengl -NOSOUND -WINDOWED -NoVSync -BENCHMARK -FPS=1000 "

echo "Input scene_id:"
read id
$PREFIX1 scenes/${scenes[id-1]}/hi.sh $PREFIX2 -settings="/home/B/xiezc/AirVLNFilter/settings/${id}.json"
